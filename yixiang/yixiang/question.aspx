<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="question.aspx.cs" MasterPageFile="~/Site.master" Inherits="yixiang.question" %>
...
<div class="index_ul" style="width:60%;border:3px solid #b6b7bc;padding:5px,5px,5px,5px; margin-left: 0px;">
    ...
    <h3 style="display:block;float:right;" ><a href="list_answer.aspx"><<了解更多</a></h4>
